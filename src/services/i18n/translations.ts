...
export const translations = {
  en: {
    ...
    overlay: {
      ...
      addCurrentButton: 'Add current video',
      addCurrentSuccess: 'Added ✓',
      addCurrentFailed: "Couldn't read this video — try again",
      captureListTitle: 'Saved',
      captureListEmpty: 'Nothing saved yet — tap "Add current video" while watching',
      favoriteListTitle: 'Favorite',
      favoriteListEmpty: 'No favorites yet — tap "Add current video" while watching',
  ...
  ko: {
    ...
    overlay: {
      ...
      menuCapture: 'Saved',
      menuFavorite: 'Favorite',
      addCurrentButton: '현재 영상 추가',
      addCurrentSuccess: '추가됐어요 ✓',
      addCurrentFailed: '이 영상을 못 읽었어요 — 다시 시도해주세요',
      captureListTitle: 'Saved',
      captureListEmpty: '아직 저장한 게 없어요 — 시청 중 "현재 영상 추가"를 눌러보세요',
      favoriteListTitle: 'Favorite',
      favoriteListEmpty: '아직 즐겨찾기가 없어요 — 시청 중 "현재 영상 추가"를 눌러보세요',
      hotListTitle: 'Shorts HOT',
