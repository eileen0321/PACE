...
export const translations = {
  en: {
    ...
    paywall: {
      ...
      privacyPolicy: 'Privacy Policy',
      autoRenewNotice: 'Subscriptions auto-renew unless cancelled at least 24 hours before the end of the current period. Payment is charged to your Apple ID account. Manage or cancel anytime in your device Settings.',
  ...
  ko: {
    ...
    paywall: {
      ...
      termsOfUse: '이용약관',
      privacyPolicy: '개인정보처리방침',
      autoRenewNotice: '구독은 현재 기간 종료 최소 24시간 전에 취소하지 않으면 자동 갱신됩니다. 결제는 Apple ID 계정으로 청구되며, 기기 설정에서 언제든 관리·취소할 수 있습니다.',
