...
export const translations = {
  en: {
    ...
    focus: {
      ...
      accessibilityPromptBanner: 'Accessibility is off — usage tracking, auto-advance, focus sessions and sleep detection are all paused. Tap to turn it back on',
      connected: 'Connected',
      ...
      camDisclosureTitle: 'Camera access needed',
      camDisclosureBody: 'Hand-wave control uses the front camera to detect your gestures. Since access was turned off, please enable Camera for Pace in Settings.',
      camDisclosureOpen: 'Open Settings',
    ...
    overlay: {
      ...
      addCurrentAlready: 'Already in favorites',
    ...
    gestureCalib: {
      eyebrow: 'Calibration',
      step1: 'Step 1 · Hold still for {{sec}} seconds',
      step2: 'Step 2 · Sweep your hand past the camera {{n}} times',
      step1of2: 'Step 1 of 2',
      step2of2: 'Step 2 of 2',
      stallHint: 'Not seeing your hand. Point the front camera at yourself and sweep about 20-30cm in front of it.',
      retry: 'Try again',
      noiseTitle: 'Hold still for a moment',
      noiseBody: 'Pace is learning what your room looks like when nothing is happening, so it can tell your wave apart from everyday movement.',
      noiseHint: 'Measuring…',
      savedLabel: 'Your threshold',
      unusableEyebrow: 'Not enough contrast',
      unusableTitle: 'Could not tell your wave apart',
      unusableBody: 'Your wave looked the same as normal movement here — often too dark or too backlit. Try again in better light, or continue with default settings.',
      ...
      openSettings: 'Open camera permission settings',
    ...
    limitReached: {
      ...
      tier3Body1: "You've passed today's goal.",
      tier3Title2: 'Time for a short break?',
      tier3Body2: 'This is a good place to stop.',
  ...
  ko: {
    ...
    focus: {
      ...
      accessibilityPromptBanner: '접근성이 꺼져 있어요 — 사용시간 추적·자동넘김·포커스 세션·수면감지가 모두 멈춥니다. 탭해서 켜주세요',
      connected: '연결됨',
      notConnected: '미연결',
      ...
      camDisclosureTitle: '카메라 권한이 필요해요',
      camDisclosureBody: '손짓으로 넘기려면 전면 카메라로 손동작을 인식해야 해요. 권한이 꺼져 있어 앱에서는 다시 켤 수 없으니, 설정에서 Pace의 카메라를 켜주세요.',
      camDisclosureOpen: '설정 열기',
      extendTime: '시간 연장',
    ...
    overlay: {
      ...
      addCurrentAlready: '이미 즐겨찾기에 있어요',
    ...
    gestureCalib: {
      eyebrow: '손짓 보정',
      step1: '1단계 · {{sec}}초간 가만히',
      step2: '2단계 · 카메라 앞으로 손 {{n}}번 지나가기',
      step1of2: '1 / 2 단계',
      step2of2: '2 / 2 단계',
      stallHint: '손이 안 보입니다. 전면 카메라가 나를 향하게 두고, 카메라에서 20~30cm 앞으로 손을 지나가 주세요.',
      retry: '다시 시도',
      noiseTitle: '잠시 가만히 계세요',
      noiseBody: '아무 일도 없을 때의 화면을 먼저 익힙니다. 그래야 손짓과 평소 움직임을 구분할 수 있어요.',
      noiseHint: '측정 중…',
      savedLabel: '내 문턱',
      unusableEyebrow: '구분이 어려워요',
      unusableTitle: '손짓을 가려내지 못했어요',
      unusableBody: '손짓이 평소 움직임과 비슷하게 보였습니다 — 너무 어둡거나 역광일 때 생깁니다. 밝은 곳에서 다시 하시거나 기본 설정으로 계속하셔도 됩니다.',
    ...
    limitReached: {
      ...
      tier3Title1: '천천히 가세요.',
      tier3Body1: '오늘 목표 시간을 넘겼어요.',
      tier3Title2: '잠시 쉬어갈까요?',
      tier3Body2: '지금이 멈추기 좋은 지점이에요.',
