...
export const translations = {
  en: {
    ...
    onboarding: {
      ...
      protocol: 'Pace',
      featureLabel: '0{{n}} / 04',
      slide1Title: 'Rest tracking',
      slide1Description: 'Put your phone down and your rest time gets recorded.',
      slide2Title: 'Earn credits',
      slide2Description: 'Your rest time earns you credits.',
      slide3Title: 'Keep watching',
      slide3Description: 'Spend credits to keep watching.',
      slide4Title: 'Sleep Mode',
      slide4Description: 'Shorts wind down automatically after your set time.',
    },
  ...
  ko: {
    ...
    onboarding: {
      ...
      featureLabel: '0{{n}} / 04',
      slide1Title: '휴식 측정',
      slide1Description: '폰을 내려놓으면 휴식 시간이 기록됩니다.',
      slide2Title: '크레딧 적립',
      slide2Description: '휴식 시간만큼 크레딧을 획득합니다.',
      slide3Title: '연속 시청',
      slide3Description: '크레딧을 사용해 시청을 이어갈 수 있습니다.',
      slide4Title: '취침 모드',
      slide4Description: '설정한 시간 이후 쇼츠 시청을 줄여줍니다.',
    },
